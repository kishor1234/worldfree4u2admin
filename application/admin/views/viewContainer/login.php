<?php
/*$sql=$main->select("post",$_SESSION["db_1"]);
...
while($row=$result->fetch_assoc())
{
    ...
    $arr=explode(':', $row["img"]);
    $nwurl= "https:".$arr[1];
    //echo $main->update(array("img"=>$nwurl),"post").$main->whereSingle(array("id"=>$row["id"]));
    $main->adminDB[$_SESSION["db_1"]]->query($main->update(array("img"=>$nwurl),"post").$main->whereSingle(array("id"=>$row["id"])));
      ...
      <div class="login-box-body">
        ...
        <form action="/?r=<?php echo $obj->encdata("C_Dashboard");?>" method="post">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="form-group has-feedback">
                <input type="email" name="email" class="form-control" placeholder="Your Email ID" required="" autocomplete="off">
