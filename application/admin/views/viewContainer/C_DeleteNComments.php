...
/**
 * Description of C_DeleteNComments
 *
 * @author asksoft
 */
...
class C_DeleteNComments extends CAaskController {
    ...
    public function initialize() {
        parent::initialize();
        $sql="UPDATE post SET comment=comment - 1 WHERE id=(select post_id FROM comment WHERE id=".$this->filterPost("id")." )";
